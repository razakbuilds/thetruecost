...
export default function AuthPage() {
  ...
  async function saveDraftIfNeeded() {
    ...
    try {
      ...
      // Dashboard can still load without the draft if saving fails.
    }
  }
